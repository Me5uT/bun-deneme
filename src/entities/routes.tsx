...
const PageNotFound = React.lazy(
  () => import("app/shared/error/page-not-found")
);
const LazyAccounts = React.lazy(() => import("./account"));
const LazyAdministratorsTempRoutes = React.lazy(
  ...
  return (
    <div className="content-container-inner">
      <Suspense fallback={<Loader />}>
        <ErrorBoundaryRoutes>
          <Route
            path={`${baseObj?.basePath}/accounts/*`}
            element={<LazyAccounts />}
          />
          <Route
            path={`${baseObj?.basePath}/sms-provider/*`}
            element={<LazySmsProvider />}
          />
          <Route
            path={`${baseObj?.basePath}/gateway-radius/*`}
            element={<LazyGatewayRadius />}
          />
          <Route
            path={`${baseObj?.basePath}/gateway-ldap/*`}
            element={<LazyGatewayLdap />}
          />
          <Route
            path={`${baseObj?.basePath}/user/*`}
            element={<LazyUserTempRoutes />}
          />
          <Route
            path={`${baseObj?.basePath}/group/*`}
            element={<LazyGroupTempRoutes />}
          />
          <Route
            path={`${baseObj?.basePath}/administration/*`}
            element={<LazyAdministratorsTempRoutes />}
          />
          <Route
            path={`${baseObj?.basePath}/attribute-profile/*`}
            element={<LazyAttributeProfile />}
          />
          <Route
            path={`${baseObj?.basePath}/radius-rules/*`}
            element={<LazyRadiusRuleTempRoutes />}
          />
          <Route
            path={`${baseObj?.basePath}/external-source/*`}
            element={<LazyLdapGroupTempRoutes />}
          />
          <Route
            path={`${baseObj?.basePath}/tenant-setting/*`}
            element={<LazyTenantSettingRoutes />}
          />
          <Route
            path={`${baseObj?.basePath}/syslog/*`}
            element={<LazySyslogSettingRoutes />}
          />
          <Route
            path={`${baseObj?.basePath}/logging-audit/*`}
            element={<LazyLoggingAuditRoutes />}
          />
          <Route
            path={`${baseObj?.basePath}/logging-radius/*`}
            element={<LazyLoggingRadiusRoutes />}
          />
          <Route
            path={`${baseObj?.basePath}/mentis-manage/*`}
            element={<LazyMentisRoutes />}
          />
          <Route
            path={`${baseObj?.basePath}/user-portal`}
            element={<LazyUserPortalRoutes />}
          />
