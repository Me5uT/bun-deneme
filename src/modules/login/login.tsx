...
export const Login = () => {
  const [isFlipped, setIsFlipped] = React.useState<'login' | 'reset' | 'prelogin'>('login');
  ...
  return (
    <div className="login-container">
      ...
      >
        ...
        >
          <LoginForm setIsFlipped={setIsFlipped} mirketCode={mirketCode} setLoginInfo={setLoginInfo} />
        </animated.div>
        ...
        >
          {isFlipped === 'reset' && <PasswordResetInit cardFlipped={setIsFlipped} />}
          {isFlipped === 'prelogin' && <PreLogin setMirketCode={setMirketCode} mirketCode={mirketCode} />}
        </animated.div>

        <div className="login-footer">
          <Space style={{ width: '100%', justifyContent: 'center' }}>
            <a href="https://mirketsecurity.com/end-user-licence-agreement/" rel="noreferrer" target="_blank">
              Terms of service
            </a>
          </Space>
          <Divider />
          <Space style={{ width: '100%', justifyContent: 'center' }}>Looking for help with your Mirket user account?</Space>
          <Space style={{ width: '100%', justifyContent: 'center', fontSize: 'smaller' }}>
            <a
              style={{
